...
CREATE TABLE `factura_proveedor` (
  `id_facturaP` char(10) NOT NULL,
  `id_proveedor` char(15) NOT NULL,
  `id_Producto` char(20) NOT NULL,
  PRIMARY KEY (`id_facturaP`),
  KEY `id_Producto` (`id_Producto`),
  KEY `id_proveedor` (`id_proveedor`),
  CONSTRAINT `factura_proveedor_ibfk_1` FOREIGN KEY (`id_Producto`) REFERENCES `producto` (`id_Producto`),
  CONSTRAINT `factura_proveedor_ibfk_2` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedor` (`id_proveedor`)
...
-- Dump completed on 2023-04-27 19:40:16
